...
if (pieColorChart !== null) {
    ...
    var data_pc = {
        labels: ["Status Updates", "Multimedia", "Shared Posts", "Articles"],
        datasets: [
            {
...
if (USMapChart !== null) {
    ...
    function drawUSRegionsMap() {
        ...
        var options = {
            ...
            displayMode: 'markers',
            legend:'none',
            colorAxis: {colors: ['#446600', '#732626']}
        };
